# node.default["rlcatalyst"]["nexusUrl"] = "http://nexus.rlcatalyst.com/nexus/content/repositories/catalyst/org/catalyst/D4D/3.02.100/D4D-3.02.100.zip"
#
...
#puts "Lazy value:" + lazy {node[:deploy_upgrade_catalyst][:app_home]}
